CLASS zcl_oops_flightif1 DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS zcl_oops_flightif1 IMPLEMENTATION.


  METHOD if_oo_adt_classrun~main.
    DATA(lo_obj) = NEW zcl_oops_flightif( ).
    CALL METHOD lo_obj->zif_oops_flightdetails~get_flightdetails
      EXPORTING
        lv_carrierid     = 'SQ'
...
*--Flight Reference
     CALL METHOD lo_obj->zif_oops_flightref~get_flightref
     EXPORTING
      lv_carrierid   = 'SQ'
      lv_connectionid = '0001'
      IMPORTING
